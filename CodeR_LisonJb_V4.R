#########################################################################################
 Lison GRAPPIN <lison.grappin@gmail.com> 
#########################################################################################
...
# La base est structur̩e de la mani̬re suivante:
# var 1:29: description de l'individu (taille,poids,cigarette,placebo,..) 
# var 30:54 donn̩es biologiques (num)
# var 55:131 historique m̩dical au sens large (logical)

# On regarde le type des donn̩es initiales
#sapply(CoreTable_training_raw,function(x) class(x)) 
# On regarde le type une fois que l'on a transform̩
...
# On recode d'autres variables mal cod̩es
